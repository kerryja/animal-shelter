        ...
        <div className="row">
          <div className="col">
            <div className="text-left">
              ...
              <hr></hr>
              <p>
                Our goal is to place the right dog in the right home. Please
                read this Adoption Process Page in full before submitting an
                application.
              </p>
              <h3>Adoption Guidelines</h3>
              <p>
                The first step in the process is to read our guidelines for
                adopting a dog from Save A Dog. See guidelines{" "}
                <Link to={"/adoption-guidelines"}>here</Link>. It is also
                important to us that you read our{" "}
                ...
                protocol will also save you from costly vet bills in the future.
              </p>
              <h3>Application</h3>
              <p>
                Fill out the Adoption Application form{" "}
                <Link to="/adoption-application">here</Link>.{" "}
                <em>
              ...
              <p>
                ...
                or so to get back to you. We are not a drop-in shelter where you
                walk through kennels. We have shelter visiting hours, usually on
                the weekends, but occasionally on weekday afternoons. We have a
                limited amount of private appointments during the week, usually
                in the daytime. Please understand that we are not a "first come,
                first serve" shelter, but that we try to make the right match
                for both the dog and the adopter. If you work full time, for
                example, we may steer you towards an adult dog who can stay at
                home during the day or who can get along just along just fine
                with a dog walker.{" "}
              </p>
              ...
              <p>
                ...
                dogs outside off-leash to meet prospective adopters. We also
                have a Meet-and-Greet room with comfy sofas in the house where
                you can meet a dog in a home setting.{" "}
                <em>
                  As some of our dogs are in foster homes, receiving an
                  application ahead of time will allow us to notify the foster
                  provider to bring the dog to the shelter for you to meet.
                </em>{" "}
                If you just drop in, there's a good chance the dog you want to
                meet might not be here, so it's best to let us know of your
                planned visit.{" "}
              </p>
              <p>
                <em>
              ...
              <p>
                ...
                visit. The deposit is nonrefundable. If you change your mind, it
                is used as a donation towards the shelter. If you continue with
                the adoption, the fee is deducted from your total adoption fee.
              </p>
            </div>
          </div>
        </div>
